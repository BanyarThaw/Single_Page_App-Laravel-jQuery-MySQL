...
@section('content')
    ...
    <div class="wrap_sub_menu_and_detail_info">
		...
		<div class="sub_menu col-md-3 col-sm-3">
			<div class="sub_menus {{ $under_line_style_rooms }}" id="body">
				<a href="/rooms/list" class="{{ $sub_title_rooms }}">Room List</a>
			</div>
			...
			<div class="sub_menus {{ $under_line_style_index }}" id="body">
				<a href="/roomtypes" class="{{ $sub_title_index }}">Room Types</a>
			</div>
			<div class="sub_menus {{ $under_line_style_create }}" id="body">
				<a href="/roomtypes/create" class="{{ $sub_title_create }}">Create Room Type</a>
			</div>
		</div>
